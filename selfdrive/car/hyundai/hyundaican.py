...
def create_acc_commands(packer, enabled, accel, idx, lead_visible, set_speed, stopping):
  ...
  scc14_values = {
    ...
    "JerkUpperLimit": 2 if enabled else 0, # stock usually is 1.0 but sometimes uses higher values
    "JerkLowerLimit": 2 if enabled else 0, # stock usually is 0.5 but sometimes uses higher values
